...
const Usuarios = (props) => {
    const columns = [
        { field: 'id', headerName: 'Nombre', width: 250 },
        { field: 'firstName', headerName: 'Tipo de Usuario', width: 200 },
        { field: 'secondName', headerName: 'Empresa', width: 200 },
        { field: 'lastName', headerName: 'Login', width: 200 },
        {
    ...
    return (
        <Container maxWidth={false} style={style.barSup}>
            <Container maxWidth={false} style={style.barTitle}>
                <h1 style={style.title}>Usuarios</h1>
