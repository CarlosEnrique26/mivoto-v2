                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12}>
                                <Grid item xs={12} md={6}>
                                    <Typography style={{ marginTop: 5, fontSize: 25 }}>Juegos</Typography>
                                </Grid>
                                            ...
                                            <div className={classes.Contenedores}>
                                                <div className={classes.PieContent}>
                                                    ...
                                                    <div className={classes.iconContent}>
                                                        <Link to="/auth/botonesnavegacionJ" className={classes.link}>
                                                            <InsertDriveFileIcon className={classes.icon} />
                                                        </Link>
                                                        <Link to="/auth/ControlesJ" className={classes.link}>
