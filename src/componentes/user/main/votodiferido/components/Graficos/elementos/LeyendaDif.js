...
{isDesktop ? (
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Longitud de Texto</Typography>
                                            </div>
                                            <div className={classes.cajones}>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Longitud de Texto</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
