import { Grid, TextField, Typography, Checkbox, Input, MenuItem, Select, InputLabel, FormControl, Radio} from '@material-ui/core';
import React, { useState } from 'react';
import { withStyles, makeStyles } from '@material-ui/core/styles';
import { useMediaQuery } from '@material-ui/core';
import Slider from '@material-ui/core/Slider';

const TextoPreguntasDif = () => {
                                    ...
                                    {isDesktop ? (
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Ancho del Contenedor</Typography>
                                            </div>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Ancho del contestador</Typography>
                                            </div>
                                        ...
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Linea Inicio</Typography>
                                            </div>
                                            ...
                                            aria-label="pretto slider" 
                                            defaultValue={20}
                                            value={sliderValues.LineaI} 
                                            onChange={(event, newValue) => handleSliderChange('LineaI',event, newValue)}
                                            />
                                            </div>
                                            ...
                                            label="TamanoFuente" 
                                            variant="outlined"
                                            value={sliderValues.LineaI} // Usa el valor del estado local como valor del TextField
                                            onChange={(e) => setSliderValues({...sliderValues, LineaI: e.target.value})} 
                                            />
                                            </div>
                                        </div>
                                        ):(
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Linea Inicio</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
                                            <Typography gutterBottom></Typography>
                                            <PrettoSlider 
...
export default TextoPreguntasDif;