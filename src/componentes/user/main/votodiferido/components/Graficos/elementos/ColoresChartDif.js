                            ...
                            <Grid item xs={12} md={12} style={{marginTop: 20}}>
                                <div className={`${classes.buttonContainer} ${isDesktop ? classes.horizontal : ''}`}>
                                    ...
                                    {isDesktop ? (
                                        ...
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <TextField type='color' style={{width:'90%'}} color='primary' id="outlined-basic" label="OPCION 4" variant="outlined" />
                                            </div>
                                            <div className={classes.alineado}>
                                                <TextField type='color' style={{width:'90%'}} color='primary' id="outlined-basic" label="OPCION 5" variant="outlined" />
                                            </div>
                                            <div className={classes.alineadoMovile}>
...
export default ColoresChartDif;