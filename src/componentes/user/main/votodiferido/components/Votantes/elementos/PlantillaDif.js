import { Grid, TextField, Typography, Checkbox, MenuItem, Select, InputLabel, FormControl, TextareaAutosize, Button} from '@material-ui/core';
                                    ...
                                    {isDesktop ? (
                                        ...
                                        <div className={classes.alineado}>
                                                    ...
                                                    <TextareaAutosize
                                                        ...
                                                        defaultValue="Entre aqui para votar: {url}, Usuario: {user} ,Pass: {pass}"
                                                        /> 
                                                    </div>
                                        </div>
                                        ) : (
...
{isDesktop ? (
                                        ...
                                        <div className={classes.alineado}>
                                                    ...
                                                    <TextareaAutosize
                                                        ...
                                                        aria-label="maximum height"
                                                        placeholder="Maximum 4 rows"
                                                        defaultValue="Aquí dispone del código de confirmación para confirmar su voto: {code}"
                                                        /> 
                                                    </div>
                                        </div>
                                        ) : (
