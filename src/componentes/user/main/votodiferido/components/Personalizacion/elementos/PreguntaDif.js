                            ...
                            <Grid item xs={12} md={12} style={{marginTop: 20}}>
                                <div className={`${classes.buttonContainer} ${isDesktop ? classes.horizontal : ''}`}>
                                    ...
                                    {isDesktop ? (
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Tipo de Letra</Typography>
                                            </div>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Tipo de Letra</Typography>
                                            </div>
                                    ...
                                    {isDesktop ? (
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Color de botón</Typography>
                                            </div>
                                            <div className={classes.cajones}>
                                                <TextField type='color' style={{width:'80%'}} color='primary' id="outlined-basic" label="Eje Vertical" variant="outlined" />
                                            </div>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Color de botón</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
                                                <TextField type='color' style={{width:'100%'}} color='primary' id="outlined-basic" label="Eje Vertical" variant="outlined" />
                                            </div>
                                        ...
                                        {isDesktop ? (
                                            <div className={classes.alineado}>
                                                <div className={classes.element}>
                                                    <Typography style={{fontSize: 18, marginLeft: 15}}>Color de Texto</Typography>
                                                </div>
                                                <div className={classes.cajones}>
                                                    <TextField type='color' style={{width:'80%'}} color='primary' id="outlined-basic" label="Eje Vertical" variant="outlined" />
                                                </div>
                                            ...
                                            <>
                                                <div className={classes.elementMovile}>
                                                    <Typography style={{fontSize: 18}}>Color de Texto</Typography>
                                                </div>
                                                <div className={classes.alineadoMovile}>
                                                    <TextField type='color' style={{width:'100%'}} color='primary' id="outlined-basic" label="Eje Vertical" variant="outlined" />
                                                </div>
                                        ...
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Curva del borde</Typography>
                                            </div>
                                            <div className={classes.cajones}>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Curva del borde</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Ancho</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
                                        ...
                                        <div className={classes.alineado}>
                                            <div className={classes.element}>
                                                <Typography style={{fontSize: 18, marginLeft: 15}}>Tamaño de letra</Typography>
                                            </div>
                                            <div className={classes.cajones}>
                                        ...
                                        <>
                                            <div className={classes.elementMovile}>
                                                <Typography style={{fontSize: 18}}>Tamaño de letra</Typography>
                                            </div>
                                            <div className={classes.alineadoMovile}>
